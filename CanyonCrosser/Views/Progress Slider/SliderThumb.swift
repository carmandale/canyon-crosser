...
struct SliderThumb<Content: View>: View where Content: Sendable {
    ...
    var size: CGFloat {
        sliderHeight - (buttonMargin * 2) - (appModel.hikerDragStateComponent.sliderBeingDragged ? 5 : 0)
    }
        ...
        ZStack {
            buttonColor
                ...
                .shadow(
                    ...
                    radius: CGFloat(appModel.hikerDragStateComponent.sliderBeingDragged ? 3 : 1.5)
                )
